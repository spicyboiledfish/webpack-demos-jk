(function (factory) {
    ...
    var Plugin = /** @class */ (function () {
        ...
        Plugin.removeLinkTag = function (html, cssFileName) {
            return html.replace(new RegExp("<link[^>]+href=['\"]" + cssFileName + "['\"][^>]+(>|/>|></link>)", 'g'), '');
        };
        ...
        Plugin.prototype.prepare = function (_a) {
            ...
            Object.keys(assets).forEach(function (fileName) {
                if (isCSS(fileName) && _this.isCurrentFileNeedsToBeInlined(fileName)) {
                    _this.css[fileName] = assets[fileName].source();
                    if (!leaveCSSFile) {
                        delete assets[fileName];
                    }
                }
                if (isHTML(fileName) && _this.isCurrentFileNeedsToBeInlined(fileName)) {
